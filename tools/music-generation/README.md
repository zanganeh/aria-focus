...
```powershell
python tools/music-generation/convert_library_to_opus.py --source apps/desktop/src-tauri/private-beta-pack --output .local/opus-library-candidate --pack-version 0.2.1-opus.1 --app-version-requirement '>=0.2.1-beta.1, <0.3.0' --dry-run
```
...
```powershell
python tools/music-generation/convert_library_to_opus.py --source apps/desktop/src-tauri/private-beta-pack --output .local/opus-library-candidate --pack-version 0.2.1-opus.1 --app-version-requirement '>=0.2.1-beta.1, <0.3.0' --max-total-bytes 300000000
```
