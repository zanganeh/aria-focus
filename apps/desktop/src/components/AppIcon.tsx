...
const icons: Record<Name, ReactNode> = {
  ...
  infinity: <path d="M7.5 16c-2.5 0-4.5-1.7-4.5-4s2-4 4.5-4c3.5 0 5.5 8 9 8 2.5 0 4.5-1.7 4.5-4s-2-4-4.5-4c-3.5 0-5.5 8-9 8Z" />,
  repeat: (
    <>
      <path d="M4 8h11a3 3 0 0 1 3 3v1" />
      <path d="m15 5 3 3-3 3" />
      <path d="M20 16H9a3 3 0 0 1-3-3v-1" />
